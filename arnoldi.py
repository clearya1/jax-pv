...
class krylovBasis:
  def __init__(
    ...
    self.basis = np.empty((self.N, self.max_size), dtype='float')
    self.hessenberg = np.zeros((self.max_size, self.max_size), dtype='float')
